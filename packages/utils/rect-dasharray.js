export function drawDashedRect(svgRect, rectProps, dashProps) {
...
function _calculateRectStrokeDasharray(rectProps, dashProps) {
  const { width, height, borderRadius } = rectProps;
...
function _validateRectDashProps(rectProps, dashProps) {
